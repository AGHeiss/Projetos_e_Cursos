...
print(max('a', 'ab', 'abc'))
print(max('a', 'b', 'c', 'g'))
print(max(3.145, 5.3423))
print(max('Geek University'))

min -> Retorna o menor item ou valor em um iterável, ou o menor de dois ou mais elementos
...
# DESAFIO! Como encontrar a musica mais tocada e a menos tocada sem usar max, min ou lambda?
